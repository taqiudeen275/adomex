...
import { getAuthor, getSingleBlog } from '@/app/action';
...
const BlogPostView = ({ params }: { params: { id: string, post: any } }) => {
    const [isLoading, setIsLoading] = useState(true);
    const [post, setPost] = useState<BlogSinglePost>({ id: "Not loaded",
        title: "Not loaded",
        date: "Not loaded",
        overview: "Not loaded",
        content: "Not loaded",
